...
const songs =[
    {
        ...
        poster: "../IMG/charlie/1.jpg"
    },
    {
        id: 2,
        songName: `One call Away<br>
        <div class="subtitle">Charlie Puth</div>`,
        poster: "../IMG/charlie/2.jpg"
    },
    {
        id: 3,
        songName: `Mother<br>
        <div class="subtitle">Charli Puth</div>`,
        poster: "./../IMG/charlie/3.jpg"
    },
    {
        id: 4,
        songName: `See You Again<br>
        <div class="subtitle">Charlie Puth</div>`,
        poster: "./../IMG/charlie/4.jpg"
    },
    {
        id: 5,
        songName: `The Way I Am<br>
        <div class="subtitle">Charlie Puth</div>`,
        poster: "../IMG/charlie/5.jpg"
    },
    {
        id: 6,
        songName: `We Don't Talk AnyMore<br>
        <div class="subtitle">Charlie Puth</div>`,
        poster: "../IMG/charlie/6.jpg"
    },
    {
        id: 7,
        songName: `Marvin Gaye<br>
        <div class="subtitle">Charlie Puth</div>`,
        poster: "../IMG/charlie/7.jpg"
    },
    {
        id: 8,
        songName: `Attention<br>
        <div class="subtitle">Charlie Puth</div>`,
        poster: "./../IMG/charlie/8.jpg"
    },
]
...
Array.from(document.getElementsByClassName('playListPlay')).forEach((e)=>{
    e.addEventListener('click',(el)=>{
        ...
        poster_master_play.src=`../IMG/charlie/${index}.jpg`;
        masterPlay.classList.remove('fa-play');
        masterPlay.classList.add('fa-pause');
        music.play();
